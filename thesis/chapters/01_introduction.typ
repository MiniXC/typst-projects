...
In @02_factors[Chapter], we introduce some general factors of speech. Definitions for factors such as prosody differ in the literature. To avoid ambiguity, this thesis will refer to our specific definition using the styled term "#smallcaps[Prosody]". The same applies for #smallcaps[Generic], #smallcaps[Speaker], #smallcaps[Intelligibility] and #smallcaps[Ambient] factors of speech.