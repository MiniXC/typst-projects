...
Given that augmenting datasets is a well-established method for improving the robustness and performance of machine learning models, and synthetic data is often easier to acquire and label than real data @pomerleau_alvinn_1988, the high subjective ratings of #abbr.a[TTS]-generated speech have inspired a number of works to utilize synthetic data for training #abbr.l[ASR] systems #citep(<li_synthaug_2018>), #citep(<rosenberg_speechaug_2019>), #citep(<thai_lrasr_2019>). This approach is referred to as TTS-for-ASR, where TTS-generated data is employed to train or augment ASR models, leveraging the controllability of speech synthesis to address data scarcity in domains such as low-resource languages or domains.
...
In our earlier works, we adressed TTS-for-ASR and the gap between synthetic and real speech for ASR model training:
...
===== Part I
-  *@02_factors*: This chapter provides an examination of various factors and representations of speech, classifying them based on their properties and purposes within speech technology.
-   *@03_tts*: This chapter offers an overview of Text-to-Speech (TTS) systems, detailing their evolution, core architectures, training objectives, and evaluation.
-   *@04_asr*: This chapter describes Automatic Speech Recognition (ASR), its underlying principles, the challenges posed by speech variability, and an overview of various ASR architectures, modeling and training techniques.
===== Part II
...
===== Part III
-   *@08_eval*: This chapter outlines the measurement of distributional distance for synthetic speech, and detailing the development and validation of the Text-to-Speech Distribution Score (TTSDS).
-   *@09_dist*: This chapter covers improvements to TTSDS which increase its robustness and versatility, as well as additional validation of TTSDS across domains and languages.

*@10_conclusions* covers conclusions, limitations and future directions of our work.
