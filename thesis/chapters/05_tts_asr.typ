...
The disparity between synthetic and true data distributions can be conceptualized by partitioning the joint distribution of speech and its corresponding text into distinct regions, as illustrated by @fig_speech_dist:
