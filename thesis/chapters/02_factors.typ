...
#minorchange[Wording]["Mel" #sym.arrow.r "mel"][
...
cal(R)^(-1)(cal(R)(S)) = S
$ <invertibe_t>
#majorchange[Rephrasing][corrected mathematical misstatement][An example is the #abbr.a[STFT], which retains both magnitude and phase (encoded within complex numbers comprising real and imaginary parts), allowing for exact reconstruction via the inverse #abbr.a[STFT] (iSTFT), while making frequencies more accessible than in waveforms, as shown in @fig:fig_transformations.]
...
==== Edge cases
#minorchange[Wording]["Mel" #sym.arrow.r "mel", #strike( "significant")][
...
#majorchange[Figure][swapped ambient and content, moved formant frequencies, renamed to "global statistics", added emotion to content][#figure(
...
#minorchange[Wording][#strike("semantic")][The #smallcaps[Speaker] factor encompasses the unique, identifying characteristics of an individual's voice. Its representations bridge the gap between acoustic reality and the concept of identity.]

#majorchange[Clarification][moved formant frequencies to both #smallcaps[Content] and #smallcaps[Speaker]][At a low level, identity is encoded in physical properties. Formant frequencies, the resonant peaks in the speech spectrum, are determined by the size and shape of the speaker's vocal tract and are thus a strong anatomical correlate @stevens_sources_1972. While formants determine vowel identity (part of the #smallcaps[Content] factor), their absolute frequency ranges are constrained by the vocal tract length, also making them a key correlate of the #smallcaps[Speaker] factor.] A speaker's habitual average pitch is another simple indicator. However, these features are highly variable and deeply entangled with other factors, making them unreliable for robust speaker identification.
...
#minorchange[Wording]["semantic" #sym.arrow.r "content"][The #smallcaps[Generic] factor includes representations that encode the full acoustic signal. They span the entire spectrum, from the purely acoustic waveform to abstract embeddings that bridge to the content domain.]
