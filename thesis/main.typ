...
First and foremost, my supervisors Ondrej Klejch and Peter Bell were encouraging, patient and full of wisdom, and I admire how they managed to guide me in my research -- it was the perfect balance, keeping me on track while also allowing a great a deal of flexibility. In particular, I will never forget a meeting in which I anxiously pointed out the research was deviating quite strongly from the initial premise and Peter simply suggested to change the title of this work -- and so we did. I would also like to thank Huawei for funding this work and for the valuable feedback their team provided.
