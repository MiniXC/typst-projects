...
// Lay Summary
#frontmatter-heading([Party Summary])
...
Text-to-Speech (TTS) technology has achieved remarkable advancements, generating synthetic voices that are increasingly difficult to distinguish from human speech in isolation. This progress led to the investigation of using TTS-generated data to train Automatic Speech Recognition (ASR) systems, which also require substantial datasets.

However, despite the high subjective naturalness of synthetic voices, their utility for training ASR models proved to be limited, resulting in significantly degraded ASR performance. This discrepancy suggested the existence of subtle differences between synthetic and real speech that influence machine learning performance.

To address this, we developed a novel approach to compare collections of synthetic and real speech, rather than individual utterances. We analyzed how various acoustic characteristics -- such as speech prosody, speaker identity, and lexical intelligibility -- are distributed across large sets of recordings. This distributional analysis revealed quantifiable differences between synthetic and authentic speech. TTS systems perceived as more natural by human listeners consistently had distributional patterns more closely resembling those of real speech. This finding holds true across diverse conditions, including speech with background noise, children's voices, and across 14 distinct languages, demonstrating the robustness of our method.

In summary, we find that while synthetic voices sound convincingly human-like individually, their aggregate characteristics still diverge from real speech in ways that impact their suitability for certain applications. Our work provides a reliable quantitative metric to measure this specific distributional gap offering a tool to guide future advancements in TTS development towards achieving full parity with the complexity of human speech.

// Acknowledgements
#frontmatter-heading([Acknowledgements])

// I'd like to thank my supervisors Ondrej Klejch and Peter Bell who were encouraging and patient, and I admire how they managed to guide me in my research -- it was a balancing act, keeping me on track while also allowing a great a deal of flexibility. 

// In particular, I will never forget a meeting in which I anxiously pointed out the research was deviating quite strongly from the initial premise and Peter simply suggested to change the title of this work -- and so we did. 

// I would also like to thank Huawei for funding this work and for the valuable feedback their team provided.

// The fellow students and scholars I have met throughout the years, within and without of CSTR, were the best reasons to come to the office and conferences and have contributed to many ideas and insights for my work. Gustav Eje Henter believed in my research from the start, and has and continues to be an endless source of advice and enthusiasm. Nick Rossenbach's research on TTS-for-ASR and discussions on the topic were inspiring and helped me find my footing in the early stages. While our research does not have much in common, Maria Dolak, Zeyu Zhao and Sung-Lin Yeh were awesome fellow 5th-floor-IF-researchers. The great discussions with fellow CSTR members, too many to list them all, have undoubtedly contributed a great deal to this work as well. 

// I am also lucky to have an incredibly supportive family. My partner Celina always lent an ear and having her by my side means the world to me. My parents always believed I could do this, even when I did not, and came for a much-needed visit to Edinburgh when times were tough. My brother Benjamin, beyond being my best friend, has been a great source of inspiration and advice, and I am excited to read his thesis when the time comes. My grandmother was also always just a call away despite the big distance.

// To my friends, beyond listening to me about the perils of academia, you have helped me keep up my resolve in so many ways. My flatmates over the years, Angus, Rory and David, have been nothing but lovely and kind. The D&D sessions with Kat, David, Elo, Alex and Sven were always a highlight, as were the runs with Sam, the hikes and climbs with Erik, gaming with the Treemteam and the discussions about German hip-hop with Dom. On that note, I would also like to thank SSIO for waiting to release his fifth album until after the submission of this thesis. 
